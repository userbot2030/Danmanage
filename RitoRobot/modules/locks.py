...
import RitoRobot.modules.sql.locks_sql as sql
...
telegram world; the bot will automatically delete them!
 ...
 ᐉ /locktypes*:* Lists all possible locktypes
 
*Admins only:*
 ᐉ /lock <type>*:* Lock items of a certain type (not available in private)
 ᐉ /unlock <type>*:* Unlock items of a certain type (not available in private)
 ᐉ /locks*:* The current list of locks in this chat.
