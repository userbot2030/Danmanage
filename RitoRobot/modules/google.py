...
from RitoRobot import telethn as tbot
from RitoRobot.events import register
...
__help__ = """
 ᐉ /google <text>*:* Perform a google search
 ᐉ /img <text>*:* Search Google for images and returns them\nFor greater no. of results specify lim, For eg: `/img hello lim=10`
 ᐉ /app <appname>*:* Searches for an app in Play Store and returns its details.
 ᐉ /reverse |pp |grs: Does a reverse image search of the media which it was replied to.
