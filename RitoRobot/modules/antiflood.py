...
from RitoRobot import TIGERS, WOLVES, dispatcher
from RitoRobot.modules.connection import connected
from RitoRobot.modules.helper_funcs.alternate import send_message
...
from RitoRobot.modules.sql import antiflood_sql as sql
...
will result in restricting that user.
 ...
 ᐉ /flood*:* Get the current flood control setting
• *Admins only:*
 ᐉ /setflood <int/'no'/'off'>*:* enables or disables flood control
 *Example:* `/setflood 10`
 ᐉ /setfloodmode <ban/kick/mute/tban/tmute> <value>*:* Action to perform when user have exceeded flood limit. ban/kick/mute/tmute/tban
• *Note:*
