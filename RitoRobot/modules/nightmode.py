...
from RitoRobot import BOT_NAME
from RitoRobot import telethn as tbot
from RitoRobot.events import register
from RitoRobot.modules.sql.night_mode_sql import (
    add_nightmode,
    get_all_chat_id,
    is_nightmode_indb,
    rmnightmode,
...
*Admins Only*
 ...
 ᐉ /nightmode*:* Adds Group to NightMode Chats
 ᐉ /rmnight*:* Removes Group From NightMode Chats
