...
from RitoRobot.modules.helper_funcs.msg_types import Types
from RitoRobot.modules.sql import BASE, SESSION
...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "hei lihatlah owner saya @MSDZULQRNN?",  # jojo jap ver
