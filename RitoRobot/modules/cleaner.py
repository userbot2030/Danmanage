...
from RitoRobot import ALLOW_EXCL, CustomCommandHandler, dispatcher
...
from RitoRobot.modules.sql import cleaner_sql as sql
...
*Blue text cleaner* removed any made up commands that people send in your chat.
 ᐉ /cleanblue <on/off/yes/no>*:* clean commands after sending
 ᐉ /ignoreblue <word>*:* prevent auto cleaning of the command
 ᐉ /unignoreblue <word>*:* remove prevent auto cleaning of the command
 ᐉ /listblue*:* list currently whitelisted commands
"""
