...
import RitoRobot.modules.sql.userinfo_sql as sql
...
from RitoRobot import telethn as FallenTelethonClient
from RitoRobot.__main__ import STATS, TOKEN, USER_INFO
from RitoRobot.modules.disable import DisableAbleCommandHandler
from RitoRobot.modules.helper_funcs.chat_status import sudo_plus
from RitoRobot.modules.helper_funcs.extraction import extract_user
from RitoRobot.modules.sql.afk_sql import check_afk_status, is_afk
from RitoRobot.modules.sql.global_bans_sql import is_user_gbanned
from RitoRobot.modules.sql.users_sql import get_user_num_chats
...
def stats(update: Update, context: CallbackContext):
    stats = "🤖 <b>Stats For <a href='https://t.me/Rito_Robot'>͔ ꝛɪᴛᴏ ꝛᴏʙᴏᴛ </a>:</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
