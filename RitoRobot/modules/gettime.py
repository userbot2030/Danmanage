...
from RitoRobot import TIME_API_KEY, dispatcher
...
__help__ = """
 ᐉ /time <query>*:* Gives information about a timezone.
*Available queries:* Country Code/Country Name/Timezone Name
 ᐉ ⏰ [Timezones list](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones)
