...
from RitoRobot import DRAGONS, LOGGER, dispatcher
from RitoRobot.modules.connection import connected
from RitoRobot.modules.disable import DisableAbleCommandHandler
from RitoRobot.modules.helper_funcs.alternate import send_message, typing_action
from RitoRobot.modules.helper_funcs.chat_status import user_admin
from RitoRobot.modules.helper_funcs.extraction import extract_text
from RitoRobot.modules.helper_funcs.filters import CustomFilters
from RitoRobot.modules.helper_funcs.handlers import MessageHandlerChecker
from RitoRobot.modules.helper_funcs.misc import build_keyboard_parser
from RitoRobot.modules.helper_funcs.msg_types import get_filter_type
from RitoRobot.modules.helper_funcs.string_handling import (
    button_markdown_parser,
    escape_invalid_curly_brackets,
    markdown_to_html,
    split_quotes,
)
from RitoRobot.modules.sql import cust_filters_sql as sql
...
*Admin only:*
 ᐉ /filter <keyword> <reply message>*:* Add a filter to this chat. The bot will now reply that message whenever 'keyword'\
 ...
 *Example:* 
 ...
 %%%
 Reply 3`
 ᐉ /stop <filter keyword>*:* Stop that filter.

*Chat creator only:*
 ᐉ /removeallfilters*:* Remove all chat filters at once.

*Note*: Filters also support markdown formatters like: {first}, {last} etc.. and buttons.
Check ᐉ /markdownhelp to know more!
