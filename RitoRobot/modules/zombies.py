...
from RitoRobot.utils.admins import can_restrict
...
*Remove Deleted Accounts*
 ...
 ᐉ /zombies *:* Starts searching for deleted accounts in the group.
 ᐉ /zombies clean *:* Removes the deleted accounts from the group.
"""
